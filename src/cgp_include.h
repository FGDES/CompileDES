...
<h2 class="groupheader">Get libFAUDES</h2>
...
(functional for Linux/macOS/MSYS environments). The configuration includes specific plug-ins 
...
vs release C-libraries. For application development <tt>static</tt>
is the choice to go.
...
project in the flavours <tt>gcc_linux</tt>, <tt>gcc_osx</tt>, <tt>cl_win</tt> and
