...
void Usage(const std::string& rMessage="") {
  ...
  std::cerr << "2) extract c declarations for luabindings interface code." << std::endl;
  std::cerr << std::endl;
  std::cerr << "usage:" << std::endl;
  std::cerr << " rti2code <rti input file> <output basename>" << std::endl;
...
int main(int argc, char *argv[]) {
  ...
  luaheader << "/* rti2code: autogenerated libFAUDES luabindings declarations: "; 
  ...
  for(fit=FunctionRegistry::G()->Begin(); fit!=FunctionRegistry::G()->End();fit++, fcnt++) {
    ...
    luaheader << "#if " << "SwigModule == \"Swig" << plugin << "\"" << std::endl;
